            ...
            <div className="post_details-info">
              <div className="flex-between w-full">
                <Link to={`/profile/${post?.creator.$id}`} className='flex items-center gap-3' >
                    <img src={post?.creator?.imageUrl || '/asset/icons/profile-placeholder.svg'} alt="creator" className='rouded-full w-8 h-8 lg:h-12  lg:w-12 ' />
                ...
                <Button 
                  onClick={ ()=>console.log('hello button click') }
                  variant="ghost"
